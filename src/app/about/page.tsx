    ...
    <div className="bg-white dark:bg-gray-900 min-h-screen transition-colors">
      <MaxWidthWrapper className="py-24">
        ...
        <div className="text-center mb-16">
          <Badge className="mb-4 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900 dark:to-indigo-900 text-blue-700 dark:text-blue-300 border-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
          <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 dark:bg-gray-800">
            <CardContent className="p-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-lg">
                ...
                searchable, understandable, and actionable through intelligent
                AI conversations. We&apos;re building a future where knowledge
                barriers disappear and insights are just a question away.
              </p>
            </CardContent>
          </Card>

          <Card className="border-0 shadow-xl bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 dark:bg-gray-800">
            <CardContent className="p-8">
              <div className="flex items-center mb-6">
              ...
              <CardContent className="p-8 lg:p-12">
                <div className="prose prose-lg max-w-none">
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                    ...
                    finding the exact insights they needed was like looking for
                    a needle in a haystack.
                  </p>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                    The breakthrough came when we realized that AI could not
                    just read documents, but truly understand them and engage in
                    meaningful conversations about their content. This
                    wasn&apos;t just about search – it was about creating an
                    intelligent companion that could help unlock the knowledge
                    hidden within every document.
                  </p>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                    Today, Fable serves thousands of professionals, researchers,
                    and students worldwide, helping them save hours of work and
                    discover insights they never knew existed. Every
                    conversation with a document brings us closer to our vision
                    of truly accessible knowledge.
                  </p>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={index}
                className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 dark:bg-gray-800 dark:border-gray-700"
              >
                <CardContent className="p-6 text-center">
                  <div
                    className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${value.gradient} bg-opacity-10 dark:bg-opacity-20 flex items-center justify-center mx-auto mb-4`}
                  >
                    {value.icon}
                  </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <Card
                key={index}
                className="border-0 shadow-lg text-center dark:bg-gray-800 dark:border-gray-700"
              >
            ...
            <Card className="border-0 shadow-lg dark:bg-gray-800 dark:border-gray-700">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                  We leverage state-of-the-art large language models combined
                  with specialized document understanding algorithms to provide
        ...
        <div className="text-center bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 p-12 rounded-2xl text-white">
          ...
          <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
            ...
            feedback, or just want to chat about the future of document
            intelligence, we&apos;re here to listen.
          </p>
