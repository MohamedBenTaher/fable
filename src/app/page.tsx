  ...
  return (
    <>
      ...
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        {/* Announcement Banner */}
        <div className="mx-auto mb-8 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50 px-7 py-2 shadow-md backdrop-blur transition-all hover:border-blue-300 hover:shadow-lg">
          <Badge
            variant="secondary"
        ...
        {/* Main Headline */}
        <h1 className="max-w-5xl text-5xl font-bold md:text-6xl lg:text-7xl text-gray-900 mb-6">
          Transform your{" "}
        ...
        {/* Subheadline */}
        <p className="mt-5 max-w-prose text-xl text-gray-700 sm:text-xl mb-8">
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 mb-10 text-sm text-gray-600">
          <div className="flex items-center space-x-2">
            ...
            <span>
              <strong className="text-gray-900">50,000+</strong> users
            </span>
          </div>
          <div className="flex items-center space-x-2">
            <FileText className="h-4 w-4 text-green-600" />
            <span>
              <strong className="text-gray-900">1M+</strong> documents processed
            </span>
          </div>
          <div className="flex items-center space-x-2">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          ...
          <button className="flex items-center space-x-2 text-gray-700 hover:text-gray-900 transition-colors">
            <div className="w-12 h-12 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-full flex items-center justify-center hover:from-blue-200 hover:to-indigo-200 transition-colors">
          ...
          {[
            ...
            >
              <CardContent className="p-8">
                <div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${feature.gradient} bg-opacity-10 flex items-center justify-center mb-4`}
                >
                  {feature.icon}
                </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 via-white to-indigo-50 py-24">
        <MaxWidthWrapper>
      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
        <div className="mb-12 px-6 lg:px-6">
          <div className="mx-auto max-w-2xl sm:text-center">
            <Badge className="mb-4 bg-gradient-to-r from-green-100 to-emerald-100 text-green-700 border-0">
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-green-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              <span className="text-sm font-medium text-green-700">Step 2</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <Card className="border-2 border-gray-200">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 mb-4">5 documents/month</p>
                  <Link
                    href="/sign-up"
                    className={buttonVariants({
                      variant: "outline",
              ...
              <Card className="border-2 border-blue-500 relative">
                ...
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 mb-4">Unlimited documents</p>
                  <Link
                    href="/pricing"
                    className={buttonVariants({
              ...
              <Card className="border-2 border-gray-200">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 mb-4">Team features + SSO</p>
                  <Link
                    href="/pricing"
                    className={buttonVariants({
                      variant: "outline",
